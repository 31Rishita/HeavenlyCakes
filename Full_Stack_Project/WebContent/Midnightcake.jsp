...
<body>   
  ...
  <div class="header">
    <h1>Midnight Cakes<span>(8 items)</span></h1>
    <div class="filter-options">
        ...
        <div id="product-row">
            <div class="product-cell" data-price="599" data-rating="4.7">
                ...
                <a href="CakeFrame2.html">
                    <img src="https://assets.winni.in/product/primary/2024/3/94562.jpeg?dpr=1&w=400" alt="Lipsmacking Black Forest Cake" class="product-image">
                </a>
            ...
            <div class="product-cell" data-price="649" data-rating="4.6">
                ...
                <img src="https://assets.winni.in/product/primary/2014/6/31158.jpeg?dpr=1&w=400" 
                alt="Lipsmacking Black Forest Cake" class="product-image">
                </a>
                <div class="product-title">Vanilla Cake</div>
                <div class="product-price">
                    ₹529 <span class="product-discount">₹699</span> <span class="product-discount-rate">24% Off</span>
                </div>
                <div class="product-rating">
                    <span class="rating-value">4.6 ★</span>
                    <span class="reviews-count">196 Reviews</span>
                </div>
                <svg class="heart-icon" onclick="toggleHeart(this)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                    <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                </svg>            </div>
            ...
            <div class="product-cell" data-price="649" data-rating="4.5">
                ...
                <img src="https://assets.winni.in/product/primary/2023/4/84499.jpeg?dpr=1&w=400" 
                alt="Lipsmacking Black Forest Cake" class="product-image"></a>
                <div class="product-title">Mouth Melting Chocolate Cake</div>
                <div class="product-price">
                    ₹579 <span class="product-discount">₹729</span> <span class="product-discount-rate">21% Off</span>
                </div>
                <div class="product-rating">
                    <span class="rating-value">4.8 ★</span>
                    <span class="reviews-count">70 Reviews</span>
                </div>
                <svg class="heart-icon" onclick="toggleHeart(this)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                    <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                </svg>            </div>
        ...
        <div class="product-cell" data-price="1499" data-rating="5.0">
            <div class="product-container">
            <a href="kids.html">
            <img src="https://assets.winni.in/product/primary/2024/4/95077.jpeg?dpr=1&w=400" 
            alt="Lipsmacking Black Forest Cake" class="product-image"></a>
            <div class="product-title">Black Forest Dreamland Cake</div>
            <div class="product-price">
                ₹799 <span class="product-discount">₹1999</span> <span class="product-discount-rate">25% Off</span>
            </div>
            <div class="product-rating">
                <span class="rating-value">4.8 ★</span>
          ...
          <div class="product-cell" data-price="550" data-rating="4.8">
            ...
            <a href="CakeFrame6.html">
              <img src="https://assets.winni.in/product/primary/2022/9/74421.jpeg?dpr=1&w=400"
               alt="Lipsmacking Black Forest Cake" class="product-image"></a>
              <div class="product-title">Belgium Chocolate Truffle Cake</div>
              <div class="product-price">
                  ₹799 <span class="product-discount">₹949</span> <span class="product-discount-rate">16% Off</span>
              </div>
              <div class="product-rating">
                  <span class="rating-value">4.5 ★</span>
                  <span class="reviews-count">146 Reviews</span>
              </div>
              <svg class="heart-icon" onclick="toggleHeart(this)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
            </svg>          </div>
          ...
          <div class="product-cell" data-price="579" data-rating="4.9">
            ...
            <a href="CakeFrame7.html">
              <img src="https://assets.winni.in/product/primary/2024/3/94560.jpeg?dpr=1&w=400" 
              alt="Lipsmacking Black Forest Cake" class="product-image"></a>
              ...
              <div class="product-rating">
                  <span class="rating-value">4.6 ★</span>
                  <span class="reviews-count">186 Reviews</span>
              </div>
              <svg class="heart-icon" onclick="toggleHeart(this)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
            </svg>          </div>
          ...
          <div class="product-cell" data-price="589" data-rating="4.4">
            ...
            <a href="CakeFrame1.html">
              <img src="https://assets.winni.in/product/primary/2024/3/94426.jpeg?dpr=1&w=400" 
              alt="Lipsmacking Black Forest Cake" class="product-image"></a>
              <div class="product-title">Red Roses And Chocolate Cake</div>
              <div class="product-price">
                  ₹1,179<span class="product-discount">₹1,629</span> <span class="product-discount-rate">28% Off</span>
              </div>
              <div class="product-rating">
                  <span class="rating-value">4.7 ★</span>
                  <span class="reviews-count">55 Reviews</span>
              </div>
              <svg class="heart-icon" onclick="toggleHeart(this)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
            </svg>          </div>
          ...
          <div class="product-cell" data-price="949" data-rating="4.9">
            ...
            <a href="CakeFrame8.html">
              ...
              <div class="product-price">
                  ₹749 <span class="product-discount">₹949</span> <span class="product-discount-rate">21% Off</span>
              </div>
              <div class="product-rating">
                  <span class="rating-value">4.7 ★</span>
