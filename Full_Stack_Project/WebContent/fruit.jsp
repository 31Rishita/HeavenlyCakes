  ...
  <div class="header">
    ...
    <div class="filter-options">
        ...
        <div id="product-row">
            <div class="product-cell" data-price="599" data-rating="4.7">
                ...
                <a href="CakeFrame2.html">
                    <img src="https://assets.winni.in/c_limit,dpr_1,fl_progressive,q_80,w_1000/84507_fruit-and-nut-cake.jpeg" alt="Lipsmacking Black Forest Cake" class="product-image">
                </a>
            ...
            <div class="product-cell" data-price="649" data-rating="4.6">
                ...
                <img src="https://assets.winni.in/c_limit,dpr_1,fl_progressive,q_80,w_1000/53442_crunchy-and-juicy-fruit-cake.jpeg" 
                alt="Lipsmacking Black Forest Cake" class="product-image">
                </a>
                <div class="badge new-arrival">New Arrival</div>
                <div class="product-title">Crunchy And Juicy Fruit Cake</div>
                <div class="product-price">
            ...
            <div class="product-cell" data-price="649" data-rating="4.5">
                ...
                <img src="https://assets.winni.in/product/primary/2024/1/93211.jpeg?dpr=1&w=1000" 
                alt="Lipsmacking Black Forest Cake" class="product-image"></a>
                <div class="badge trending">Trending</div>
                <div class="product-title">Fruit Infused Chocolate Cake</div>
                <div class="product-price">
        ...
        <div class="product-cell" data-price="1499" data-rating="5.0">
            <div class="product-container">
            <a href="kids.html">
            <img src="https://assets.winni.in/product/primary/2023/10/90477.jpeg?dpr=1&w=1000" 
            alt="Lipsmacking Black Forest Cake" class="product-image"></a>
            <div class="badge best-seller">Best Seller</div>
            <div class="product-title">Spanish Fruit Cake</div>
            <div class="product-price">
          ...
          <div class="product-cell" data-price="550" data-rating="4.8">
            ...
            <a href="CakeFrame6.html">
              <img src="https://assets.winni.in/c_limit,dpr_1,fl_progressive,q_80,w_1000/74621_fruity-crunchy-cream-cake.jpeg"
               alt="Lipsmacking Black Forest Cake" class="product-image"></a>
               <div class="badge new-arrival">New Arrival</div>
              <div class="product-title">Fruity Crunchy Cream Cake</div>
              <div class="product-price">
          ...
          <div class="product-cell" data-price="579" data-rating="4.9">
            ...
            <a href="CakeFrame7.html">
              <img src="https://assets.winni.in/product/primary/2022/9/73478.jpeg?dpr=1&w=500" 
              alt="Lipsmacking Black Forest Cake" class="product-image"></a>
              <div class="badge new-arrival">New Arrival</div>
              <div class="product-title">Mix Fruit Gateaux Cake</div>
              <div class="product-price">
          ...
          <div class="product-cell" data-price="589" data-rating="4.4">
            ...
            <a href="CakeFrame1.html">
              <img src="https://www.gretchensveganbakery.com/wp-content/uploads/2022/06/cali-fruit-cake-resized-3.jpg" 
              alt="Lipsmacking Black Forest Cake" class="product-image"></a>
              <div class="badge best-seller">Best Seller</div>
          ...
          <div class="product-cell" data-price="949" data-rating="4.9">
            ...
            <a href="CakeFrame8.html">
              <img src="https://assets.winni.in/product/primary/2024/1/93183.jpeg?dpr=1&w=500" 
              alt="Lipsmacking Black Forest Cake" class="product-image"></a>
              <div class="badge trending">Trending</div>
              <div class="product-title">Delectable Fruit Heart Cake</div>
              <div class="product-price">
