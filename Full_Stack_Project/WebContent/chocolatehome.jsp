...
<body>  
    ...
    <div class="breadcrumb">
      <a href="#">Home</a> &gt; <a href="#">Chocolate Cakes</a>
  </div>
  <div class="header">
    <h1>Chocolate Cakes<span>(8 items)</span></h1>
    <div class="filter-options">
        ...
        <div id="product-row">
            <div class="product-cell" data-price="599" data-rating="4.7">
                ...
                <a href="chocolateframe.jsp">
                    <img src="https://assets.winni.in/product/primary/2023/4/84499.jpeg?dpr=1&w=400" alt="Lipsmacking Black Forest Cake" class="product-image">
                </a>
            ...
            <div class="product-cell" data-price="649" data-rating="4.6">
                <div class="product-container">
                <a href="chocolateframe.jsp">
                <img src="https://assets.winni.in/product/primary/2024/3/94564.jpeg?dpr=1&w=400" 
            ...
            <div class="product-cell" data-price="649" data-rating="4.5">
                <div class="product-container">
                <a href="chocolateframe.jsp">
                <img src="https://assets.winni.in/product/primary/2023/3/83221.jpeg?dpr=1&w=400" 
        ...
        <div class="product-cell" data-price="1499" data-rating="5.0">
          ...
          <div class="product-cell" data-price="589" data-rating="4.4">
            <div class="product-container">
            <a href="chocolateframe.jsp">
              <img src="https://assets.winni.in/product/primary/2024/3/94612.jpeg?dpr=1&w=400" 
              alt="Lipsmacking Black Forest Cake" class="product-image"></a>
          ...
          <div class="product-cell" data-price="949" data-rating="4.9">
            <div class="product-container">
            <a href="chocolateframe.jsp">
              <img src="https://assets.winni.in/product/primary/2024/2/93942.jpeg?dpr=1&w=400" 
              alt="Lipsmacking Black Forest Cake" class="product-image"></a>
              <div class="product-title">Marble Crunch Cake</div>
              <div class="product-price">
